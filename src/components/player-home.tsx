...
import { FrostedCover } from "@/components/frosted-cover";

type PlayerHomeProps = {
  onListen: () => void;
};

export function PlayerHome({ onListen }: PlayerHomeProps) {
  return (
    <div className="player">
      ...
      <div className="player-stage">
        <FrostedCover onActivate={onListen} />
      </div>
      ...
      <footer className="player-actions">
        ...
        <button type="button" className="player-listen" onClick={onListen}>
          <span>LISTEN</span>
        </button>
      </footer>
    </div>
